...
(async () => {
  ...
  const state = data.getAutoResultState();
  assert.equal(state.markets.taiwan.sourceDateTime, '2026-08-17 16:10:00');
  assert.equal(state.markets['totomacau-22'].sourceDateTime, '2026-08-17 22:10:00');
  assert.equal(state.markets['totomacau-21-5d'].sourceDateTime, '2026-08-17 21:10:00');
